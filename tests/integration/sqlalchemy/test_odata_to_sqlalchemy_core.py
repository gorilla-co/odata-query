...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            > dt.datetime(2018, 1, 1, 1, 2, 3, 123_000),
        ),
        (
            'published_at gt 2018-01-01T01:02:03.123456',
            BlogPost.c.published_at
            > dt.datetime(2018, 1, 1, 1, 2, 3, 123_456),
        ),
        (
            'published_at gt 2018-01-01T01:02Z',
            BlogPost.c.published_at
            > dt.datetime(2018, 1, 1, 1, 2, tzinfo=tz(0)),
        ),
        (
            'published_at gt 2018-01-01T01:02:03Z',
            BlogPost.c.published_at
            > dt.datetime(2018, 1, 1, 1, 2, 3, tzinfo=tz(0)),
        ),
        (
        ...
        (
            ...
            BlogPost.c.published_at
            > dt.datetime(2018, 1, 1, 1, 2, tzinfo=tz(+2)),
        ),
        (
            'published_at gt 2018-01-01T01:02-02:00',
            BlogPost.c.published_at
        ...
        (
            ...
            (BlogPost.c.id == 1)
            & (
                (BlogPost.c.content == 'executing')
                | (BlogPost.c.content == 'failed')
            ),
        ),
        ...
        (
            ...
            functions.char_length(BlogPost.c.title)
            == functions.char_length('flippot'),
        ),
        (
            "title eq concat('a', 'b')",
        ...
        (
            ...
            BlogPost.c.title
            == functions.concat(functions.concat('a', 'b'), 'c'),
        ),
        (
        ...
        (
            ...
            functions_ext.substr(BlogPost.c.title, literal(0) + 1, 4)
            == 'Copy',
        ),
        (
        ...
        (
            "trim(title) eq 'copy'",
            functions_ext.ltrim(functions_ext.rtrim(BlogPost.c.title))
            == 'copy',
        ),
        (
